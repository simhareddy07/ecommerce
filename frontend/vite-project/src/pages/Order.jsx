...
return(<>order conformation</>)
    ...
    //             const addressResponse = await axios.get('http://localhost:5000/api/user/addresses', {
    ...
    //             const cartResponse = await axios.get('http://localhost:5000/api/product/cartproducts', {
    //                 params: { email: email },
    //             });
